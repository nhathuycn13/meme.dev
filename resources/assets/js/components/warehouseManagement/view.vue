        ...
        <section class="invoice">
            ...
            <div class="row no-print">
                <div class="col-xs-12">
                    ...
                    <button v-if="status.id != 3 && status.id != 4" @click="setToDone" type="button" class="btn btn-success"><i class="fa fa-check"></i> Trạng thái: đã nhập</button>
                    <button v-if="status.id != 2 && status.id != 3 && status.id != 4" @click="setToPending" type="button" class="btn btn-warning"><i class="fa fa-check"></i> Trạng thái: yêu cầu nhập</button>
    ...
    export default{
        ...
        methods : {
            ...
            setToPending : function () {
                this.$http.put('api/warehouse/nk/' + this.$route.params.id, {'setToPending' : true}).then(function (response) {
            ...
            setToDone : function () {
                this.$http.put('api/warehouse/nk/' + this.$route.params.id, {'setToDone' : true}).then(function (response) {
                    this.notify('Success!', 'success', 'Updated!!!');
                    this.status = response.body;
                }, function (response) {
                    console.log(response.body);
