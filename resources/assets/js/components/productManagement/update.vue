<template>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3>Update Product #{{$route.params.id}}</h3>
        </div>
        <div class="panel-body">
            <div class="form form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <img id="imageLoad" class="img img-responsive img-thumbnail" @load="updateThumbnail" :src="item.thumbnail"/>
...
<script>
    export default{
        ...
        methods : {
            ...
            updateItem : function () {
                this.$http.put('api/product/' + this.$route.params.id, { 'data' : this.item}).then(function (response) {
