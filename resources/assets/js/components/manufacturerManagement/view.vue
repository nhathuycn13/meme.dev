            ...
            <div class="row">
                <div class="col-xs-12">
                    <h2 class="page-header">
                        Chi tiết nhà sản xuất #MA{{ getId(form.id) }}
            ...
            <div class="row invoice-info">
                <div class="col-sm-4">
                    <dl class="dl-horizontal">
                        ...
                        <dt>Type</dt>
                        <dd><p v-for="type in form.types">{{ type.name }}</p></dd>
    ...
    export default{
        ...
        methods : {
            ...
            deleteMe : function () {
                ...
                if (!confirm) return;
                this.$Progress.start();
                this.$http.delete('api/manufacturer/' + this.form.id).then(function (response) {
                    if (response.body == '1'){
