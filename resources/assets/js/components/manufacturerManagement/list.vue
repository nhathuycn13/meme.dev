                            ...
                            <div class="table-responsive mailbox-messages">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr v-for="item in items">
                                        ...
                                        <td><router-link :to="{ name:'view', params : { id : item.id} }">{{ item.code }}</router-link></td>
                                        <td>
                                            <div class="btn-group">
    ...
    export default{
        ...
        methods : {
            fetchData : function (page) {
                this.$Progress.start();
                this.$http.get('api/manufacturer', { params : { page : page, perpage : this.data.per_page}}).then(function (response) {
