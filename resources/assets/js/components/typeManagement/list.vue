    ...
    export default{
        ...
        methods : {
            fetchData : function (page) {
                this.$Progress.start();
                this.$http.get('api/type', { params : { page : page, perpage : this.data.per_page}}).then(function (response) {
            ...
            deleteMulti : function (id) {
                ...
                if (!confirm) return;
                this.$Progress.start();
                this.$http.delete('api/type/0', {params : {ids: this.selected}}).then(function (response) {
                    todoHuy : viet hoa
                    this.notify('Deleted', 'success', '');
                    this.fetchData(1);
                    this.$Progress.finish();
            ...
            search : function () {
                this.$Progress.start();
                this.$http.post('api/type/search', { keyword : this.keyword}).then(function (response) {
