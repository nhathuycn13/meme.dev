            ...
            <div class="col-xs-12">
                <form @submit.prevent="addNew" class="form form-horizontal">
                    ...
                    <div class="form-group" :class="{'has-error': form.$errors.has('fax')}">
                        ...
                        <div class="col-sm-8">
                            <input v-model="form.$fields.fax" class="form-control">

                            <label v-if="form.$errors.has('fax')" class="control-label"><i class="fa fa-times-circle-o"></i> {{form.$errors.$errors.fax[0]}}</label>
                        </div>
                    </div>
