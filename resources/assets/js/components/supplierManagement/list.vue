    ...
    export default{
        ...
        methods : {
            fetchData : function (page) {
                this.$Progress.start();
                this.$http.get('api/supplier', { params : { page : page, perpage : this.data.per_page}}).then(function (response) {
            ...
            deleteItem : function (id) {
                ...
                if (!confirm) return;
                this.$Progress.start();
                this.$http.delete('api/supplier/' + id).then(function (response) {
                    if (response.body == '1'){
            ...
            search : function () {
                this.$Progress.start();
                this.$http.post('api/supplier/search', { keyword : this.keyword}).then(function (response) {
