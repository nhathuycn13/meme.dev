                    ...
                    <tr>
                        <td align="center" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="600" id="templateBody">
                                <tr>
                                    <td valign="top">
{{--                                        {{ dd($quote->orderDetail) }}--}}
                                        <!-- // Begin Module: Standard Content \\ -->
                                        <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content00">
                                                        <h1 class="h1">Bảng Báo Giá</h1>
                                                        <strong>Kính gửi:</strong> {{ $quote->customer->name }}
                                                        <br>
                                                        <strong>địa chỉ:</strong> {{ $quote->customer->address }}
                                                        <br>
                                                        <strong>điện thoại:</strong> {{ $quote->customer->phone }}
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td valign="top" style="padding-top:0; padding-bottom:0;">
                                                    <table border="0" cellpadding="10" cellspacing="0" width="100%" class="templateDataTable">
                                                        <tr>
                                                            <th scope="col" valign="top" class="dataTableHeading" mc:edit="data_table_heading00">
                                                                STT
                                                            </th>
                                                            <th scope="col" valign="top" class="dataTableHeading" mc:edit="data_table_heading01">
                                                                Sản Phẩm
                                                            </th>
                                                            <th scope="col" valign="top" class="dataTableHeading" mc:edit="data_table_heading02">
                                                                Số Lượng
                                                            </th>
                                                            <th scope="col" valign="top" class="dataTableHeading" mc:edit="data_table_heading02">Thành Tiền</th>
                                                        </tr>
                                                        @foreach($quote->orderDetail as $key => $item)
                                                        <tr mc:repeatable>
                                            ...
                                            <tr>
                                                <td valign="top" class="bodyContent">
                                                    <div mc:edit="std_content01">
                                                        để đồng ý báo gía trên, chúng tôi abcxyz bạn, vui lòng nhấn chọn link họăc liên hệ trực tiếp số điện thoại 0123456789. Cám ơn quách khí.
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="middle" class="templateButtonContent">
                                                                <div mc:edit="std_content02">
                                                                    <a href="http://www.mandrill.com/" style="color: white;" target="_blank">đồng ý mua hàng</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <div mc:edit="std_footer">
                                                        <em>Copyright &copy; *2016* *In1*, All rights reserved.</em>
                                                        <br />
                                                        <strong>Email:</strong>
                                                        <br />
                                                        *abc@xyz.com*
